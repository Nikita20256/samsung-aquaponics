...
#define MBED_CONF_APP_WIFI_PASSWORD                                           "67658589"                                                                                       // set by application
#define MBED_CONF_APP_WIFI_SSID                                               "MERCUSYS_7AF9"                                                                                  // set by application
...
#define MBED_CONF_NSAPI_DEFAULT_WIFI_PASSWORD                                 "12345678"                                                                                       // set by application[*]
#define MBED_CONF_NSAPI_DEFAULT_WIFI_SECURITY                                 WPA_WPA2                                                                                         // set by application[*]
#define MBED_CONF_NSAPI_DEFAULT_WIFI_SSID                                     "realme"                                                                                         // set by application[*]
...
#define MBED_CONF_MBED_MQTT_TESTS_BROKER_HOSTNAME "192.168.8.52"
#define MBED_CONF_MBED_MQTT_TESTS_TOPIC "test"
#define MBED_CONF_MBED_MQTT_TESTS_PUBLIC_TOPIC_ENABLE false
#define MBED_CONF_MBED_MQTT_TESTS_PUBLIC_TOPIC_NAME "mbed_public_test_topic"
#define MBED_CONF_MBED_MQTT_TESTS_MQTT_SN_ENABLE false
#define MBED_CONF_MBED_MQTT_TESTS_USERNAME_PASSWORD_PROTECTION_ENABLE false
#define MBED_CONF_MBED_MQTT_TESTS_TLS_ENABLE false
#define MBED_CONF_MBED_MQTT_TESTS_USERNAME "mbed"
#define MBED_CONF_MBED_MQTT_TESTS_PASSWORD "1234"
#define MBED_CONF_MBED_MQTT_TESTS_USERNAME_ALWAYS false
